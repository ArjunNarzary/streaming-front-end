...
<div class="container-md-fluid">
    ...
    <div class="d-sm-flex align-items-center justify-content-between mt-4 mb-3">
                  <h1 class="h5 mb-0 text-gray-900">Search Results for "{{$keyword}}"</h1>
    </div>
    <div class="d-sm-flex align-items-center justify-content-between mt-4 mb-3">
                              ...
                              <div class="card m-card shadow border-0">
                                 <a href="{{ route('movie.view', ['id' => $movie->slug]) }}">
                                    <div class="m-card-cover">
                                       ...
                                       <img class="img-fluid rounded-top" src="{{asset('storage/movies/'.$movie->banner)}}" height="420" width="280">
                                    </div>
         ...
         <div class="card m-card shadow border-0">
            <a href="{{ route('series.view', ['id' => $serie->slug]) }}">
               <div class="m-card-cover">
                  ...
                  <img class="img-fluid rounded-top" src="{{asset('storage/series/'.$serie->banner)}}" height="420" width="280">
               </div>
               <div class="card-body p-3">
