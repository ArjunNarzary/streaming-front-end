<!-- Topbar -->
    <nav class="navbar navbar-expand navbar-dark topbar mb-4 pl-0 static-top shadow">
        ...
        @csrf
            ...
            <input type="text" class="form-control bg-white border-0 small @error('search') is-invalid @enderror" name="search" placeholder="Search for Movies and TV Series" aria-label="Search" aria-describedby="basic-addon2">
        ...
        <ul class="navbar-nav ml-auto">
            ...
            <form class="form-inline mr-auto w-100 navbar-search" method="get" action="{{route('search')}}">
                @csrf
                    <div class="input-group">
                        <input type="text" class="form-control bg-light border-0 small @error('search') is-invalid @enderror" name="search" placeholder="Search for Movies and TV Series" aria-label="Search" aria-describedby="basic-addon2">
            ...
            <img class="img-profile rounded-circle" src="{{ auth::user()->avatar != NULL ? asset('storage/avatar/'.auth::user()->avatar) : asset('storage/avatar/default.jpg')}}"> 
            ...
            <div class="dropdown-menu dropdown-menu-right shadow animated--grow-in" aria-labelledby="userDropdown">
                ...
                <a class="dropdown-item" href="{{route('user.rented.movie')}}">
                <i class="fas fa-list-alt fa-sm fa-fw mr-2 text-gray-400"></i>
                Rented Movies
                </a>
                <a class="dropdown-item" href="{{route('user.rented.series')}}">
                <i class="fas fa-list-alt fa-sm fa-fw mr-2 text-gray-400"></i>
                Rented TV Series
                </a>
