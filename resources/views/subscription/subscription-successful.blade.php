...
<head>
    ...
    <title>stream.getThrills.com | Subscription Successful</title>
        ...
        <div class="message-box p-3">
           <div class="ticked text-center">
            ...
            <div class="booking text-center px-5 py-3">
                <p>Your have successfully subscribed to the <span class="text-dark">{{ $plan->name }}</span> plan . Your bill has been sent to your email address and Mobile number. You can also download your bill from My Subscription.</p>
            </div>
            <div class="d-flex justify-content-around pb-3">
                <a href="/"><button class="btn btn-primary text-uppercase px-4">Home</button></a>
                <a href="{{ route('user.mysubscription') }}"><button class="btn btn-danger text-uppercase">My Subscription</button></a>
            </div>
        </div>
    </section>
