                              ...
                              <div class="card m-card shadow border-0">
                                 <a href="{{ route('movie.view', ['id' => $movie->slug]) }}">
                                    <div class="m-card-cover">
                                       ...
                                       <img class="img-fluid rounded-top" src="{{asset('storage/movies/'.$movie->banner)}}" height="420" width="350">
                                    </div>
                           ...
                           <div class="col-xl-3 col-md-6 col-12 mb-4">
                              ...
                              <div class="card m-card shadow border-0">
                                    ...
                                    <div class="card-body p-3">
                                       ...
                                       <p class="card-text">Amount : &#8377; {{number_format($movie->amount,2)}}</p>
                                    </div>
                                    <form method="POST" action="{{ route('rent.payment') }}">
                                      @csrf 
